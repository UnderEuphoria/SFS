...
export default {
  ...
  Initialize() {
    Vue.axios.post("/pouch").then((res) => {
      this.data = res.data.sort(function(obj1, obj2){
          return parseInt(obj1.sort) - parseInt(obj2.sort);
      });
      setTimeout(this.InitializeSchedule, 1500);
    })
  },
  InitializeSchedule() {
